...
async function createAdmin() {
  try {
    await mongoose.connect("mongodb+srv://abhishekgawade:ZKB9fcvqNceiTZXp@cluster0.cvop4eh.mongodb.net/indi_test?retryWrites=true&w=majority&appName=Cluster0");
